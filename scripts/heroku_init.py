...
def init_heroku_database():
    ...
    print("Инициализация базы данных на Heroku...")
    ...
    try:
        ...
        if existing_tests > 0:
            print(f"✅ База данных уже содержит {existing_tests} тестов. Пропускаем инициализацию.")
            return
        ...
        db.commit()
        print("✅ База данных успешно инициализирована на Heroku!")
